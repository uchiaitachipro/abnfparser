...
//     * @return BNFIndexNode
//     */
//    private BNFIndexNode createIndexNode(final Token token, final String keyValue) {
...
//     * @return String
//     */
//    private String getStringValue(final Token token) {
//
...
//     * @return boolean
//     */
//    public boolean isStartNode(final Token token) {
//        String value = token.getStringValue();
...
//     * @return boolean
//     */
//    public boolean isEndNode(final Token token) {
//        String value = token.getStringValue();
//        return value.equals("}") || value.equals("]");
//    }
//
...
//     * @return boolean
//     */
//    public boolean isKey(final Token token) {
//
//        boolean key = false;
//        String value = token.getStringValue();
//
...
//     * @return boolean
//     */
//    public boolean isValue(final Token token) {
//        String value = token.getStringValue();
//        return !value.equals(":") && !value.equals(",");
//    }
//
...
//     * @return Token
//     */
//    public Token getNextToken(final Token token) {
//
//        Token nextToken = token.getNextToken();
//        return nextToken;
//    }
