...
/**
 * Implementation of the TokenizerFactory.
 */
public class BNFTokenizerFactoryImpl extends AbsTokenFactory {
     ...
     * @param lastType -
     */
    private void calculateFastForward(final BNFFastForward ff, final BNFTokenizerType type, final Stack<Token> stack, final BNFTokenizerType lastType) {
     ...
     * @param c -
     */
    private void addBNFToken(final Stack<Token> stack, final BNFTokenizerType type, final char c) {
     ...
     * @param c -
     */
    private void addBNFToken(final Stack<Token> stack, final BNFTokenizerType type, final String c) {
